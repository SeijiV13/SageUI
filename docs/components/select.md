...
<div class="sage-form-control">
  <label class="sage-label">
    <span class="sage-label-text">Country</span>
  </label>
...
<div class="demo-container">
  ...
  <div class="demo-grid gap-4">
    <div class="flex flex-col items-center gap-2">
      ...
      <select class="sage-select sage-select-sm">
        <option>Small</option>
      </select>
    </div>
    <div class="flex flex-col items-center gap-2">
    ...
    <div class="flex flex-col items-center gap-2">
      ...
      <select class="sage-select sage-select-lg">
        <option>Large</option>
      </select>
    </div>
  </div>
...
<div class="demo-container">
  ...
  <div class="demo-grid gap-4">
    <div class="flex flex-col items-center gap-2">
      ...
      <select class="sage-select sage-select-primary">
        <option>Primary</option>
      </select>
    </div>
    <div class="flex flex-col items-center gap-2">
      <span class="text-xs">Secondary</span>
      <select class="sage-select sage-select-secondary">
        <option>Secondary</option>
      </select>
    </div>
    <div class="flex flex-col items-center gap-2">
      <span class="text-xs">Success</span>
      <select class="sage-select sage-select-success">
        <option>Success</option>
      </select>
    </div>
    <div class="flex flex-col items-center gap-2">
      <span class="text-xs">Warning</span>
      <select class="sage-select sage-select-warning">
        <option>Warning</option>
      </select>
    </div>
    <div class="flex flex-col items-center gap-2">
      <span class="text-xs">Error</span>
      <select class="sage-select sage-select-error">
        <option>Error</option>
      </select>
    </div>
  </div>
...
<div class="demo-container">
  ...
  <div class="demo-grid gap-4">
    <div class="flex flex-col items-center gap-2 opacity-50">
      ...
      <select class="sage-select" disabled>
    ...
    <div class="flex flex-col items-center gap-2">
      ...
      <select class="sage-select sage-select-ghost">
        <option>Ghost</option>
      </select>
    </div>
  </div>
...
<div class="demo-container">
  ...
  <div class="sage-form-control">
    <label class="sage-label">
      <span class="sage-label-text">Select multiple options</span>
    </label>
    <select class="sage-select sage-select-bordered" multiple size="4">
...
<div class="demo-container">
  ...
  <select class="sage-select sage-select-bordered w-full max-w-xs">
...
<div class="sage-form-control w-full max-w-xs">
  <label class="sage-label">
    ...
    <span class="sage-label-text-alt">Required</span>
  </label>
  <select class="sage-select sage-select-bordered w-full max-w-xs" required>
  ...
  <label class="sage-label">
    <span class="sage-label-text-alt">We use this to show you local times</span>
  </label>
</div>
```
...
<div class="dropdown w-full max-w-xs">
  <label tabindex="0" class="sage-btn sage-btn-outline w-full justify-between">
    <span id="selected-text">Choose framework</span>
    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
    </svg>
  </label>
  
  <div tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-full">
    <input type="text" class="sage-input sage-input-bordered sage-input-sm mb-2" placeholder="Search..." id="search-input">
...
searchInput.addEventListener('input', function() {
  ...
  options.forEach(option => {
    ...
    option.parentElement.style.display = text.includes(searchTerm) ? '' : 'none';
  });
});
...
| Class | Description |
|-------|-------------|
| `sage-select` | Base select styles |
| `sage-select-bordered` | Adds border styling |
| `sage-select-ghost` | Ghost/transparent styling |
| `sage-select-xs` | Extra small size |
| `sage-select-sm` | Small size |
| `sage-select-lg` | Large size |
| `sage-select-primary` | Primary color variant |
| `sage-select-secondary` | Secondary color variant |
| `sage-select-success` | Success color variant |
| `sage-select-warning` | Warning color variant |
| `sage-select-error` | Error color variant |
...
<div class="card w-full max-w-lg bg-base-100 shadow-xl">
  <div class="card-body">
    ...
    <div class="sage-form-control">
      <label class="sage-label">
        <span class="sage-label-text">Job Title</span>
      </label>
      <select class="sage-select sage-select-bordered">
...
<div class="flex flex-wrap gap-4">
  <div class="sage-form-control">
    <label class="sage-label">
      <span class="sage-label-text">Category</span>
    </label>
  ...
  <div class="sage-form-control">
    <label class="sage-label">
      <span class="sage-label-text">Sort by</span>
    </label>
    <select class="sage-select sage-select-bordered sage-select-sm">
  ...
  <div class="sage-form-control">
    <label class="sage-label">
      <span class="sage-label-text">Show</span>
    </label>
    <select class="sage-select sage-select-bordered sage-select-sm">
