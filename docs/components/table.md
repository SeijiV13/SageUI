...
```html
<div class="overflow-x-auto">
  <table class="sage-table sage-table-zebra w-full">
    <thead>
      <tr>
        <th>Name</th>
        <th>Email</th>
    ...
    <tbody>
      <tr>
        ...
        <td><div class="sage-badge sage-badge-success">Active</div></td>
      </tr>
      <tr>
        <td>Jane Smith</td>
        <td>jane@example.com</td>
        <td><div class="sage-badge sage-badge-warning">Pending</div></td>
      </tr>
      <tr>
        <td>Bob Johnson</td>
        <td>bob@example.com</td>
        <td><div class="sage-badge sage-badge-error">Inactive</div></td>
      </tr>
    </tbody>
  </table>
</div>
...
```html
<div class="overflow-x-auto">
  <table class="sage-table sage-table-compact w-full">
    <thead>
      <tr>
        <th>ID</th>
        <th>Name</th>
    ...
    <tbody>
      <tr class="hover">
        ...
        <td>
          ...
          <br/>
          <span class="sage-badge sage-badge-ghost sage-badge-sm">Desktop Support</span>
        </td>
        <td>
          <button class="sage-btn sage-btn-ghost sage-btn-xs">details</button>
        </td>
      </tr>
      <tr class="hover">
        <th>
        ...
        <td>
          Tax Accountant
          <br/>
          <span class="sage-badge sage-badge-ghost sage-badge-sm">Accounting</span>
        </td>
        <td>
          <button class="sage-btn sage-btn-ghost sage-btn-xs">details</button>
        </td>
  ...
  <table class="sage-table w-full">
    ...
    <tbody>
      <tr>
        <td>Project Alpha</td>
        <td>2024-01-15</td>
        <td><div class="sage-badge sage-badge-success">Completed</div></td>
      </tr>
      <tr>
        <td>Project Beta</td>
        <td>2024-01-20</td>
        <td><div class="sage-badge sage-badge-warning">In Progress</div></td>
      </tr>
      <tr>
        <td>Project Gamma</td>
        <td>2024-01-25</td>
        <td><div class="sage-badge sage-badge-error">Pending</div></td>
      </tr>
    </tbody>
  </table>
</div>
...
<div class="flex justify-between items-center mt-4">
  ...
  <div class="btn-group">
    <button class="sage-btn sage-btn-sm">«</button>
    <button class="sage-btn sage-btn-sm sage-btn-active">1</button>
    <button class="sage-btn sage-btn-sm">2</button>
    <button class="sage-btn sage-btn-sm">3</button>
    <button class="sage-btn sage-btn-sm">...</button>
    <button class="sage-btn sage-btn-sm">50</button>
    <button class="sage-btn sage-btn-sm">»</button>
  </div>
</div>
```
...
<div class="overflow-x-auto">
  <table class="sage-table w-full">
    ...
    <tbody>
      <tr>
        <td>
          <button class="sage-btn sage-btn-ghost sage-btn-xs expand-btn" data-target="order-001">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <ul class="text-sm">
                  ...
                  <li>• Monitor Stand - $89.99</li>
                </ul>
              </div>
              <div>
                <p><strong>Shipping:</strong></p>
                <p class="text-sm">123 Main St, City, State 12345</p>
                <p class="text-sm">Expected delivery: Jan 25, 2024</p>
              </div>
            </div>
          </div>
        </td>
...
<div class="flex flex-wrap gap-4 mb-4">
  <div class="sage-form-control">
    <input type="text" class="sage-input sage-input-bordered sage-input-sm" placeholder="Search..." id="table-search">
  </div>
  <select class="sage-select sage-select-bordered sage-select-sm" id="status-filter">
    <option value="">All Statuses</option>
    <option value="active">Active</option>
    <option value="inactive">Inactive</option>
    <option value="pending">Pending</option>
  </select>
  <select class="sage-select sage-select-bordered sage-select-sm" id="role-filter">
...
<!-- Table -->
<div class="overflow-x-auto">
  <table class="sage-table sage-table-zebra w-full" id="data-table">
    <thead>
      <tr>
        <th>Name</th>
        <th>Email</th>
    ...
    <tbody>
      <tr data-role="admin" data-status="active">
        <td>Alice Johnson</td>
        <td>alice@example.com</td>
        <td><div class="sage-badge sage-badge-primary">Admin</div></td>
        <td><div class="sage-badge sage-badge-success">Active</div></td>
        <td>
          <div class="flex gap-1">
            <button class="sage-btn sage-btn-ghost sage-btn-xs">Edit</button>
            <button class="sage-btn sage-btn-ghost sage-btn-xs text-error">Delete</button>
          </div>
        </td>
      </tr>
      <tr data-role="user" data-status="inactive">
        <td>Bob Smith</td>
        <td>bob@example.com</td>
        <td><div class="sage-badge sage-badge-secondary">User</div></td>
        <td><div class="sage-badge sage-badge-error">Inactive</div></td>
        <td>
          <div class="flex gap-1">
            <button class="sage-btn sage-btn-ghost sage-btn-xs">Edit</button>
...
const table = new Table({
  ...
  columns: [
    ...
    { 
      key: 'role', 
      label: 'Role', 
      render: (value) => `<div class="sage-badge sage-badge-primary">${value}</div>`
    }
  ],
  sortable: true,
  selectable: true,
      ...
      <tr>
        ...
        <td>
          <div class="dropdown dropdown-end">
            <label tabindex="0" class="sage-btn sage-btn-ghost sage-btn-xs">⋮</label>
...
| Class | Description |
|-------|-------------|
| `sage-table` | Base table styles |
| `sage-table-zebra` | Alternating row colors |
| `sage-table-compact` | Reduced padding |
| `sage-table-pin-rows` | Pin header/footer rows |
| `sage-table-pin-cols` | Pin first/last columns |
  ...
  <div class="card-body">
    <div class="flex justify-between items-center mb-4">
      ...
      <div class="flex gap-2">
        <select class="sage-select sage-select-bordered sage-select-sm">
